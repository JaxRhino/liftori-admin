...
// Tenant CRM (/crm/:platformId) — per-tenant LABOS backend, self-wraps CrmProvider
...
import CrmOperationsFulfillment from './pages/crm/operations/OperationsFulfillment'
    ...
    <AuthProvider>
      ...
      <WebSocketProvider>
        <VideoCallProvider>
          ...
          {/* Tenant CRM — /crm/:platformId -> CrmLayout (self-wraps CrmProvider).
              Admins enter via platform card; tenant owners log into their own CRM.
              NOTE: AuthContext.myPlatformId is NOT currently provided, so owner
              self-login is gated by AdminRoute for now (admin/impersonation only).
              Restore AuthContext.myPlatformId + swap AdminRoute -> CrmRoute as a
              follow-up to enable true tenant-owner self-login. */}
          <Route path="/crm/:platformId" element={
            ...
            <Route path="pipeline" element={<CrmSales />} />
            <Route path="operations" element={<CrmOperations />}>
              ...
              <Route path="fulfillment" element={<CrmOperationsFulfillment />} />
            </Route>
            ...
            {/* KEC industry hub layer (Csc components appended by CrmLayout for kec tenants) */}
