...
// Liftori-team config home. Consolidates the four CRM library
// tools (Reports, Automations, Estimate Templates, Email
// Templates) under one tabbed surface so they stop crowding
// the top-level admin nav. Each tab renders the existing page
// component (which reads from the main Liftori DB).
// ============================================================
      ...
      <div className="border-b border-navy-700/50 bg-navy-900/60 px-4 pt-6">
        <div className="mx-auto max-w-7xl">
          ...
          <p className="mt-1 text-sm text-slate-400">
            Internal CRM library + workflow tools. These configure the templates and reports the team works from.
          </p>
