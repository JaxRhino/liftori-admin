...
function RockDialog({ open, onClose, onSave }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm" onClick={onClose}>
      <div className="bg-navy-800/50 border border-navy-700/50 rounded-xl w-full max-w-md shadow-2xl" onClick={e => e.stopPropagation()}>
        ...
        <div className="p-6 space-y-4">
          <input
            ...
            className="w-full bg-navy-700/30 border border-navy-600/50 rounded-lg px-3 py-2 text-white text-sm placeholder-gray-500 focus:outline-none focus:border-amber-500"
            autoFocus
          />
          <select
            value={form.owner_id}
            onChange={e => setForm(f => ({ ...f, owner_id: e.target.value }))}
            className="w-full bg-navy-700/30 border border-navy-600/50 rounded-lg px-3 py-2 text-white text-sm focus:outline-none focus:border-amber-500"
          >
          ...
          <div className="flex gap-3 pt-4">
            ...
            <button
              onClick={onClose}
              className="flex-1 bg-navy-700/30 border border-navy-600/50 text-gray-300 px-4 py-2 rounded-lg hover:bg-navy-700/50 transition-colors"
            >
              Cancel
            </button>
          </div>
      ...
      <div className="bg-navy-800/50 border border-navy-700/50 rounded-xl w-full max-w-md shadow-2xl" onClick={e => e.stopPropagation()}>
        ...
        <div className="p-6 space-y-4">
          <input
            ...
            className="w-full bg-navy-700/30 border border-navy-600/50 rounded-lg px-3 py-2 text-white text-sm placeholder-gray-500 focus:outline-none focus:border-emerald-500"
            autoFocus
          />
          <select
            value={form.assigned_to}
            onChange={e => setForm(f => ({ ...f, assigned_to: e.target.value }))}
            className="w-full bg-navy-700/30 border border-navy-600/50 rounded-lg px-3 py-2 text-white text-sm focus:outline-none focus:border-emerald-500"
          >
      ...
      <div className="bg-navy-800/50 border border-navy-700/50 rounded-xl w-full max-w-md shadow-2xl" onClick={e => e.stopPropagation()}>
        ...
        <div className="p-6 space-y-4">
          <input
            ...
            className="w-full bg-navy-700/30 border border-navy-600/50 rounded-lg px-3 py-2 text-white text-sm placeholder-gray-500 focus:outline-none focus:border-red-500"
            autoFocus
          />
          <select
            value={form.priority}
            onChange={e => setForm(f => ({ ...f, priority: e.target.value }))}
            className="w-full bg-navy-700/30 border border-navy-600/50 rounded-lg px-3 py-2 text-white text-sm focus:outline-none focus:border-red-500"
          >
    ...
    <div className="min-h-screen bg-navy-900">
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-400">Run structured Level 10 meetings for your team and consulting clients</p>
        </div>
          ...
          <button
            ...
            className={`px-6 py-2 rounded-lg font-medium transition-colors ${
              activeTab === TABS.INTERNAL
                ...
                : 'bg-navy-800/50 border border-navy-700/50 text-gray-400 hover:text-gray-300'
            }`}
          >
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div className="bg-navy-800/50 border border-navy-700/50 rounded-xl p-4">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-gray-400 text-sm">Open To-Dos</p>
              ...
              <div className="bg-navy-800/50 border border-navy-700/50 rounded-xl p-4">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-gray-400 text-sm">Active Rocks</p>
            ...
            {/* Upcoming Meetings */}
            <div className="bg-navy-800/50 border border-navy-700/50 rounded-xl p-6">
              ...
              {loading ? (
                ...
                <p className="text-gray-500 py-8 text-center">No upcoming meetings scheduled</p>
              ) : (
                <div className="space-y-3">
                  {meetings.slice(0, 5).map(m => (
                    <div key={m.id} className="flex items-center justify-between p-3 bg-navy-700/20 rounded-lg hover:bg-navy-700/40 transition-colors">
            ...
            <div className="bg-navy-800/50 border border-navy-700/50 rounded-xl p-6">
              ...
              {loading ? (
                ...
                <p className="text-gray-500 py-8 text-center">No rocks yet</p>
              ) : (
                <div className="space-y-2 max-h-64 overflow-y-auto">
                  {rocks.map(r => (
                    <div key={r.id} className="flex items-center justify-between p-3 bg-navy-700/20 rounded-lg">
            ...
            <div className="bg-navy-800/50 border border-navy-700/50 rounded-xl p-6">
              ...
              {loading ? (
                ...
                <p className="text-gray-500 py-8 text-center">No to-dos yet</p>
              ) : (
                <div className="space-y-2 max-h-64 overflow-y-auto">
                  {todos.map(t => (
                    <div key={t.id} className="flex items-center justify-between p-3 bg-navy-700/20 rounded-lg">
                      <div className="flex items-center gap-3 flex-1">
                        <CheckSquare className="w-5 h-5 text-emerald-400" />
                        <div className="flex-1">
            ...
            <div className="bg-navy-800/50 border border-navy-700/50 rounded-xl p-6">
              ...
              {loading ? (
                ...
                <p className="text-gray-500 py-8 text-center">No issues yet</p>
              ) : (
                <div className="space-y-2 max-h-64 overflow-y-auto">
                  {issues.map(i => (
                    <div key={i.id} className="flex items-center justify-between p-3 bg-navy-700/20 rounded-lg">
                      <div className="flex items-center gap-3 flex-1">
                        <AlertTriangle className="w-5 h-5 text-red-400" />
        ...
        {activeTab === TABS.CLIENTS && (
          <div className="space-y-6">
            {loading ? (
              ...
              <div className="bg-navy-800/50 border border-navy-700/50 rounded-xl p-12 text-center">
                <Building2 className="w-12 h-12 text-navy-600 mx-auto mb-4" />
                <p className="text-gray-400">No client engagements yet</p>
              </div>
            ) : (
              <div className="grid gap-6">
                {clients.map(client => {
                  ...
                  return (
                    <div key={client.id} className="bg-navy-800/50 border border-navy-700/50 rounded-xl p-6 hover:border-navy-600/50 transition-colors">
                      <div className="flex items-start justify-between mb-4">
                        <div>
                          ...
                          <p className="text-gray-400 text-sm mt-1">{client.client_contact_email}</p>
                        </div>
                        <button className="bg-blue-500/20 border border-blue-500/50 text-blue-300 px-4 py-2 rounded-lg hover:bg-blue-500/30 transition-colors flex items-center gap-2 text-sm">
                      ...
                      <div className="grid grid-cols-3 gap-4 mt-4">
                        <div>
                          <p className="text-gray-400 text-xs mb-1">Next Meeting</p>
                        ...
                        <div>
                          <p className="text-gray-400 text-xs mb-1">Total Meetings</p>
                          <p className="text-white font-medium">{clientMeetings.length}</p>
                        </div>
                        <div>
                          <p className="text-gray-400 text-xs mb-1">Last Rating</p>
