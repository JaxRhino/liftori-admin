...
const TECH_STACK_OPTIONS = [
  ...
  'React Native', 'Flutter', 'Vite',
  'TypeScript', 'GraphQL', 'REST API',
  'Cloudflare', 'Redis', 'Docker'
]
            ...
            <div className="flex items-center justify-between mb-3">
              ...
              {editing && (
                <button
                  ...
                  className="text-xs bg-purple-500/20 text-purple-400 hover:bg-purple-500/30 px-3 py-1 rounded-md transition-colors disabled:opacity-50 flex items-center gap-1.5"
                >
                  {generatingBrief ? (
                    <>
