...
const salesHubItems = [
  {
    label: 'Product Demos', path: '/admin/sales-products', icon: (
  ...
  {
    label: 'Landing Page', path: '/admin/landing-page', icon: (
      <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
const devLabItems = [
  {
    label: 'Liftori', path: '/admin/liftori', icon: (
      <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  {
    label: 'Feature Library', path: '/admin/feature-library', icon: (
      <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  {
    label: 'Customer Portal', path: '/admin/customer-portal', icon: (
      <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
const opsItems = [
  ...
  {
    label: 'Measurement Requests', path: '/admin/measurement-requests', icon: (
      <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  {
    label: 'Custom Builds', path: '/admin/custom-builds', icon: (
      <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        ...
        <nav className="flex-1 py-4 space-y-1 px-2 overflow-y-auto" onClick={(e) => { if (e.target.closest('a')) { setMobileMenuOpen(false); setSidebarHovered(false); } }}>
          ...
          {visibleNavItems.map((item, idx) => (
            <React.Fragment key={item.path}>
              ...
              {((item.label === 'Call Center') || (item.label === 'Dashboard' && !visibleNavItems.some(i => i.label === 'Call Center'))) && showSalesHub && (<>
                <div>
                  <button
